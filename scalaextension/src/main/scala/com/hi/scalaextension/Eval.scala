...
import com.hi.scalaextension.string._
import java.io._
...
class Eval(target: Option[File]) {
  ...
  def compileCode(className: String, code: String, resetState: Boolean): java.lang.Class[_] = {
     compiler(code, className, resetState)
  }
  /**
